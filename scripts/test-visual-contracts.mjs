...
assert.match(styles, /\.site-header \.site-nav\s*\{\s*display: grid;\s*grid-template-columns: repeat\(2, minmax\(0, 1fr\)\);/, "Mobile navigation must expose all eight categories without horizontal discovery.");
